...
public class AddGeneralRepairPost extends AppCompatActivity implements FirebaseDatabaseHelper.onAddGeneralRepairItemCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_general_repair_post);
        try{
            ...
            llAddPhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    CropImage.activity()
                            ...
                            .start(AddGeneralRepairPost.this);
                }
            ...
            btnAddSparePart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (newPostImgUri == null) {
                        Toast.makeText(AddGeneralRepairPost.this, "Please Choose Image First", Toast.LENGTH_SHORT).show();
                        return ;
                    }
                    ...
                    if (postModel.getDescription().isEmpty()) {
                        ...
                        progressDialog.show();
                        firebaseDatabaseHelper.addGeneralRepairItem(postModel,newPostImgUri,AddGeneralRepairPost.this);
                    }
                }
            });
        }catch (Exception e){
    ...
    private void setupProgressDialog() {
        progressDialog = new ProgressDialog(AddGeneralRepairPost.this);
    ...
    @Override
    public void onAddGeneralRepairItemCompleted(String models) {
